...
$PAGE->navbar->add(get_string('assignbatch', 'local_batchmanagement'));
$PAGE->set_title(get_string('assignbatch', 'local_batchmanagement'));
$PAGE->set_heading(get_string('assignbatch', 'local_batchmanagement'));
...
echo $OUTPUT->render_from_template('local_batchmanagement/assignbatch', $hash);
