...
$PAGE->set_url('/local/batchmanagement/index.php', ['college' => $userid]);
$PAGE->navbar->add(get_string('batch_list', 'local_batchmanagement'), new moodle_url('/local/batchmanagement/batchlist.php'));
$PAGE->navbar->add(get_string('addbatch', 'local_batchmanagement'));
$PAGE->set_title(get_string('addbatch', 'local_batchmanagement'));
$PAGE->set_heading(get_string('addbatch', 'local_batchmanagement'));
...
echo $OUTPUT->render_from_template('local_batchmanagement/addbatch', $hash);
$PAGE->requires->js_call_amd('local_batchmanagement/addbatch', 'init');
echo $OUTPUT->footer();